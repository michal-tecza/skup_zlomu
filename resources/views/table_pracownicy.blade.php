...
<html>
 ...
 <form action="pracownik_del" method="post" style="display:inline-block; float:right;">
 ...
 <table id="table" class="table table-bordered" style="margin-top:10px; overflow:hidden;">
    <thead>
        <tr style="background-color:white; ">
            <th style="white-space:nowrap;"><input style="width:100px" type="text" id="search1" placeholder="id_pracownik"/><img src='https://www.iconspng.com/uploads/simple-grey-search-icon.png' style="display:inline-block; width:20px; height:20px;"></th>
            <th style="white-space:nowrap;"><input style="width:100px" type="text" id="search2" placeholder="imie"/><img src='https://www.iconspng.com/uploads/simple-grey-search-icon.png' style="display:inline-block; width:20px; height:20px;"></th>
            <th style="white-space:nowrap;"><input style="width:100px" type="text" id="search3" placeholder="nazwisko"/><img src='https://www.iconspng.com/uploads/simple-grey-search-icon.png' style="display:inline-block; width:20px; height:20px;"></th>
            <th style="white-space:nowrap;"><input style="width:100px" type="text" id="search4" placeholder="telefon"/><img src='https://www.iconspng.com/uploads/simple-grey-search-icon.png' style="display:inline-block; width:20px; height:20px;"></th>
            <th style="white-space:nowrap;"><input style="width:100px" type="text" id="search5" placeholder="wynagrodzenie"/><img src='https://www.iconspng.com/uploads/simple-grey-search-icon.png' style="display:inline-block; width:20px; height:20px;"></th>
            <th style="white-space:nowrap;"><input style="width:100px" type="text" id="search6" placeholder="haslo"/><img src='https://www.iconspng.com/uploads/simple-grey-search-icon.png' style="display:inline-block; width:20px; height:20px;"></th>
        </tr>
    </thead>
    <tbody>
    @foreach($pracownicy_lista as $key => $value)
        <tr>
            <td class="col1">{{ $value->id_pracownik }}</td>
            <td class="col2">{{ $value->imie }}</td>
            <td class="col3">{{ $value->nazwisko }}</td>
            <td class="col4">{{ $value->telefon }}</td>
            <td class="col5">{{ $value->wynagrodzenie }}</td>
            <td class="col6">{{ $value->haslo }}</td>
        </tr>
    @endforeach
    </tbody>
 </table>
