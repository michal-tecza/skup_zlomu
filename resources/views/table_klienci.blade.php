...
<html>
 ...
 <form action="klient_del" method="post" style="display:inline-block; float:right;">
 ...
 <table id="table" class="table table-bordered" style="margin-top:10px; overflow:hidden;">
    <thead>
        <tr style="background-color:white; ">
            <th style="width:216px"><input type="text" id="search1" placeholder="id_klient"/><img src='https://www.iconspng.com/uploads/simple-grey-search-icon.png' style="display:inline-block; width:20px; height:20px;"></th>
            <th style="width:217px"><input type="text" id="search2" placeholder="imie"/><img src='https://www.iconspng.com/uploads/simple-grey-search-icon.png' style="display:inline-block; width:20px; height:20px;"></th>
            <th style="width:216px"><input type="text" id="search3" placeholder="nazwisko"/><img src='https://www.iconspng.com/uploads/simple-grey-search-icon.png' style="display:inline-block; width:20px; height:20px;"></th>
            <th style="width:215px"><input type="text" id="search4" placeholder="telefon"/><img src='https://www.iconspng.com/uploads/simple-grey-search-icon.png' style="display:inline-block; width:20px; height:20px;"></th>
            
        </tr>
    </thead>
    <tbody>
    @foreach($klienci_lista as $key => $value)
        <tr>
            <td class="col1">{{ $value->id_klient }}</td>
